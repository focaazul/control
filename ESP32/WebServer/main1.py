...
# Defino el pin 2 como salida y llamo led al objeto.
led = Pin(2, Pin.OUT)
...
def web_page():
  ...
  html = """<html>
		<head> 
			<title>ESP32 Web Server. ver 1.0</title> 
		...
		<body> 
			<h1>Domohome Web Server Ver. 1.0 </h1> 
				<table class="egt">
				  <tr>
					<td><p>Luz Planta Alta: <strong>""" + gpio_state + """</strong></p></td>
					<td><p><a href="/?led=on"><button class="button">ON</button></a></p></td>
					<td><p><a href="/?led=off"><button class="button button2">OFF</button></a></p></td>
				  </tr>
				  <tr>
					<td><p>Luz Planta Baja: <strong>""" + gpio_state + """</strong></p></td>
					<td><p><a href="/?led=on"><button class="button">ON</button></a></p></td>
					<td><p><a href="/?led=off"><button class="button button2">OFF</button></a></p></td>
				  </tr>
                  <tr>
                    <td><p>Alarma: <strong>""" + gpio_state + """</strong></p></td>
                    <td><p><a href="/?led=on"><button class="button">ON</button></a></p></td>
                    <td><p><a href="/?led=off"><button class="button button2">OFF</button></a></p></td>
                  </tr>
				</table>
